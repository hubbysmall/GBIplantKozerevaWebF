...
<body>
    <form id="form2" runat="server">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList" TypeName="GBIplantService.realizationDB.GBIingridientsServiceDB"></asp:ObjectDataSource>
    </form>
</body>
</html>
